...
#
# Hera uses slurm
#SBATCH -J driver_expt1
#SBATCH -o driver_expt1.o%j
#SBATCH -N 1
#SBATCH -n 1
##SBATCH -p hera
#SBATCH -t 01:00:00 
...
setenv EXPT      test_12      # The experiment name that you are running
...
setenv FCST_RANGE              24    #Length of MPAS forecasts (hours)
...
setenv  COLD_START_INITIAL_CONDITIONS_MODEL HRRR.pressure # (GFS, GEFS, RRFS, HRRR.pressure)
setenv  COLD_START_BOUNDARY_CONDITIONS_MODEL GFS

setenv ENS_SIZE             10 # Ensemble size for the forecasts. Ensemble forecasts for all members are run all at once.
...
setenv   UNGRIB_OUTPUT_DIR_MODEL      /scratch2/BMC/fv3lam/HWT/expt_1/${EXPT}/ungrib_met  #Top-level WPS/Ungrib output directory for model data (sub-dirs by ensemble member and date)
setenv   UNGRIB_OUTPUT_DIR_SST        /scratch2/BMC/fv3lam/HWT/expt_1/${EXPT}/ungrib_sst  #Top-level WPS/Ungrib output directory for SST data    (sub-dirs by ensemble member and date)
setenv   MPAS_INIT_OUTPUT_DIR_TOP     /scratch2/BMC/fv3lam/HWT/expt_1/${EXPT}/${MESH}/mpas_init   #Top-level directory holding MPAS initialization files (sub-dirs by ens member date)
setenv   EXP_DIR_TOP                  /scratch2/BMC/fv3lam/HWT/expt_1/${EXPT}/${MESH}/mpas_atm  #Directory where MPAS forecasts are run
setenv   MPASSIT_OUTPUT_DIR_TOP       /scratch2/BMC/fv3lam/HWT/expt_1/${EXPT}/${MESH}/mpassit  #Directory where MPAS forecasts are post-processed by MPASSIT
setenv   UPP_OUTPUT_DIR_TOP       /scratch2/BMC/fv3lam/HWT/expt_1/${EXPT}/${MESH}/upp  #Directory where MPAS forecasts are post-processed by UPP
