...
#
foreach iter ( 0 1 2 ) #atj
#foreach iter ( 1 2 ) #atj: add "0" iter for ic data only, use "1" iter for lbc data. also note variables set differently for member 0 (gfs lbc) than other members
